...
export const DEFAULT_RULES: Rule[] = [
  ...
  { id: 'rule-8', pattern: 'SHELL|CHEVRON|EXXON|BP|MOBIL|GAS|SUNOCO|VALERO|SPEEDWAY|76 GAS', category: 'Gas & Fuel', clean_merchant: 'Gas Station', priority: 5 },
  ...
  { id: 'rule-10', pattern: 'CONED|ELECTRIC|WATER|PG&E|NATIONAL GRID|VERIZON|AT&T|T-MOBILE|COMCAST|XFINITY|SPECTRUM', category: 'Utilities & Bills', clean_merchant: 'Utility Provider', priority: 5 },
